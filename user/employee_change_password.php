...
// Fetch the current employee's ID from the session (assuming it's stored during login)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT Password FROM employees WHERE Employee_ID = '$employee_id'";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($current_password, $stored_password)) {
            ...
            if ($new_password === $confirm_password) {
                ...
                $update_sql = "UPDATE employees SET Password = '$hashed_password' WHERE Employee_ID = '$employee_id'";
...
<body>
    ...
    <!-- JavaScript for Hide/Show Password and Validation -->
    <script>
